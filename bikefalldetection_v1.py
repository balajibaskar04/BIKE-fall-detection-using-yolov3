...
video = cv2.VideoCapture('videos/byke_2.mp4')
        ...
        for i in results.flatten():
            ...
            # angle = calculate_angle(x_min, y_min, box_width, box_height)
                ...
                if abs(angle - 45) <= angle_threshold:
                    ...
                    cv2.line(frame, (center_x, y_min), (center_x, y_min + box_height), red_color, 2)
                    ...
                    cv2.line(frame, (center_x, y_min), (center_x, y_min + box_height), green_color, 2)
